...
<body>
			...
			<form id="form1">
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="img-box">
			                <img src="img/avtar.png" id="profile-pic" width="150" height="150" alt="">
	...
	<div class="mainsec">
		<div class="container">
			<div class="row" style="width: 100%; float: left">
				<div class="heading">
					<div class="col-sm-8" style="display: -webkit-inline-box;">
						<div class="adddoc" style="font-weight: bold; margin-right: 2rem">Add Post</div>
			...
			<div class="row" id="app" style="width: 100%; float: left" >
				<!-- <div class="td1"> -->
				<!-- </div> -->
			</div>
		</div>
